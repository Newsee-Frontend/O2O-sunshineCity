...
import { autoForm } from '../../../../service/Form/auto-form'; //require auto form data API
...
const LoadingData = _t => {
  ...
  if (vm.isLocal) {
    if (!ns.base.isEmpty(vm.localData)) {
  ...
  function _decorate(vm) {
    ...
    const initModelData = ns.base.deepClone(vm.formData.modelData);
