...
import subconfig from '../../../../ns-base/Form/tree/subconfig';
import { getInitShowData } from '../../../../../service/Form/checkbox-tree-select';
...
export default {
  ...
  methods: {
    ...
    createSelectShow(dataFrom) {
      ...
      //multiple situation
      if (this.multiple) {
        if (ns.base.judgeType(dataFrom) !== 'array') {
      ...
      //single situation
        ...
        if (ns.base.judgeType(dataFrom) !== 'object') {
